...
parser = argparse.ArgumentParser("Bundle a collection of bitmaps into a flat image")

parser.add_argument('-o', '--output', help='name of output bundle file', dest='output', default='bundle.img')
